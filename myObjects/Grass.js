...
(function() {
    ...
    Grass.prototype.init = function (drawingState) {
        ...
        this.buffers[2] = createGLBuffer(gl, nm, gl.STATIC_DRAW);
    }

    Grass.prototype.center = function () {
        return this.position;
    }

    Grass.prototype.draw = function (drawingState) {
        var gl = drawingState.gl;

        gl.useProgram(this.program);
        gl.disable(gl.CULL_FACE);

        var modelM = twgl.m4.scaling([this.scale,this.scale, this.scale]);
